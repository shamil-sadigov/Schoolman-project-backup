...
namespace Schoolman.Student.Infrastructure.Migrations
{
    ...
    [Migration("20200107122148_Refresh token changed")]
    partial class Refreshtokenchanged
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Schoolman.Student.Infrastructure.AppRole", b =>
                {
            ...
            modelBuilder.Entity("Schoolman.Student.Infrastructure.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Schoolman.Student.Infrastructure.Data.Identity.RefreshToken", b =>
                {
                    ...
                    b.Property<long>("Created_unixTime");

                    b.Property<long>("Expires_unixTime");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Schoolman.Student.Infrastructure.AppRole")
                        .WithMany()
