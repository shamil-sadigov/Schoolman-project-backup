...
namespace Authentication.Services
{
    public class AuthService : IAuthService
    {
        ...
        private readonly IConfirmationEmailManager emailConfirmationManager;
        private readonly ILogger<AuthService> logger;

        public AuthService(IUserService userService,
                                     IAuthTokenService tokenService,
                                     IConfirmationEmailManager emailConfirmationManager,
        ...
        public async Task<Result<User>> RegisterUserAsync(UserRegistrationRequest request)
        {
            ...
            {
                logger.LogInformation("Registraion failed: User provided invalid registration values. " +
            ...
            if (!emailSent)
            {
                logger.LogInformation("Sending confirmation email failed: UserId {Id}, Email {Email}",
                                  createdUser.Id, createdUser.Email);
